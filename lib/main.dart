...
import 'package:tugas3_ptpm/pages/astonvilla.dart';
import 'package:tugas3_ptpm/pages/chelsea.dart';
import 'package:tugas3_ptpm/pages/everton.dart';
import 'package:tugas3_ptpm/pages/leicester.dart';
import 'package:tugas3_ptpm/pages/liverpool.dart';
import 'package:tugas3_ptpm/pages/mancity.dart';
import 'package:tugas3_ptpm/pages/arsenal.dart';
import 'package:tugas3_ptpm/pages/tottenham.dart';
import 'package:tugas3_ptpm/pages/westham.dart';
import 'package:tugas3_ptpm/pages/wolverhampton.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          appBar: AppBar(
            title: Text("Best Premier League Club"),
          ),
          body: ListView(
            children: <Widget>[
              Card(
